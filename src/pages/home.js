    ...
    const importExcel = (e) => {
        ...
        import('xlsx').then(xlsx => {
            ...
            reader.onload = (e) => {
                ...
                let _importedCols = cols.map(col => ({ field: col.replace(/\s/g, ''), header: toCapitalize(col) }));
                let _importedData = data.map(d => {
                    return cols.reduce((obj, c, i) => {
    ...
    <div className="inner">
      ...
      <div>
       ...
       <div className="card">
            ...
            <div className="card">
                <h5>Fit Mode</h5>
                <DataTable value={products} resizableColumns columnResizeMode="fit" showGridlines onColumnResizeEnd={resizer} reorderableColumns onColReorder={resizer} >
